...
function RadioGroupSub(props) {
  ...
  return (
    <div className="flex flex-col space-y-1 my-2">
      ...
      <div tabindex="1" className="grid grid-cols-2 md:grid-cols-3 group px-2 py-4 border bg-slate-50 text-gray-500 border-gray-300 rounded transition duration-300 focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200 shadow-md">
