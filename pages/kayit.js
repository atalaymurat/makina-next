      ...
      <div className="h-full flex items-center p-4 bg-gray-100 lg:justify-center">
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white bg-green-600 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            ...
            <p className="mt-6 font-normal text-center mx-6 text-gray-300 md:mt-0">
              Digital pazarlama gereksinimleriniz ile uğraşmak için farklı bir çözüm
              mü arıyorsunuz ? Farkılı pazarlama enstrümanlarına mı ihtiyaç duyuyorsunuz ? Hesabınızı oluşturun, ve müşterilerilerin size
              ulaşmasına olanak sağlayın.
            </p>
          ...
          <div className="p-5 bg-white md:flex-1">
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <a
                  href="#"
                  className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-yellow-400 rounded-md group hover:bg-yellow-400 focus:outline-none"
                >
                  <span>
